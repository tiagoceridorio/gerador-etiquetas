...
function bindFormEvents() {
  ['productName', 'productDesc', 'fabricDate', 'validDate', 'usageText', 'productEmoji', 'qty', 'hasBanner', 'bannerColor', 'colorNome', 'colorDesc', 'colorDatas', 'bannerOpacity', 'bannerWidth', 'bannerHeight', 'bannerTopSpace', 'bannerRepeat']
    .forEach(function(id) {
