...
function bindFormEvents() {
  ['productName', 'productDesc', 'fabricDate', 'validDate', 'usageText', 'productEmoji', 'qty', 'hasBanner', 'bannerColor', 'bannerFontColor', 'bannerOpacity', 'bannerWidth', 'bannerHeight', 'bannerTopSpace', 'bannerRepeat']
    .forEach(function(id) {
